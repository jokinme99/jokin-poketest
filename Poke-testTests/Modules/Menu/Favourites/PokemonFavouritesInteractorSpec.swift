//
//  PokemonFavouritesInteractorSpec.swift
//  Poke-testTests
//
...
class PokemonFavouritesInteractorSpec: QuickSpec {
    override func spec() {
        var interactor: PokemonFavouritesInteractor!
        beforeEach {
            interactor = PokemonFavouritesInteractor()
        }
