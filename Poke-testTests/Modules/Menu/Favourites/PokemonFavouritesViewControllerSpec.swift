//
//  PokemonFavouritesViewControllerSpec.swift
//  Poke-testTests
//
...
class PokemonFavouritesViewControllerSpec: QuickSpec {
    override func spec() {
        var viewController: PokemonFavouritesViewController!
        ...
        beforeEach {
            viewController = PokemonFavouritesViewController()
