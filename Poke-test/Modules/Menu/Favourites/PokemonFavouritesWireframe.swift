...
class PokemonFavouritesWireframe {
    ...
    var mainTabBarModule: UIViewController?
}
...
extension PokemonFavouritesWireframe: PokemonFavouritesWireframeDelegate {
    ...
    func openPokemonListWindow() {
        mainTabBarModule = MainTabBarWireframe.createMainTabBarModule()
        guard let mainTabBarModule = mainTabBarModule else {return}
